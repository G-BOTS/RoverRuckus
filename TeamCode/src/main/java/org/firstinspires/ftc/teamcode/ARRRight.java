 ...
 */
@Autonomous(name="Rover: ARRRight", group="Rover")
public class ARRRight extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        liftDrive(MAX_SPEED,0, 14.0);// for contracting the scissor lift */
        ...
        encoderDrive(TURN_SPEED, TURN_SPEED, -360, 360, 5.0); // Left 90
