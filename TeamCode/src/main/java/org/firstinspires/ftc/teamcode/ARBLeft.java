...
public class ARBLeft extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        encoderDrive(TURN_SPEED, -TURN_SPEED, 250, -250, 5.0); // 304.8 = 1 Foot, Turn left 45 degrees
        encoderDrive(-DRIVE_SPEED, -DRIVE_SPEED, -920, -920, 5.0); // Straight 1524
        encoderDrive(TURN_SPEED, -TURN_SPEED, 280, -280, 5.0); // Left 90
        encoderDrive(-DRIVE_SPEED, -DRIVE_SPEED, -1524, -1524, 5.0); // Straight 1524
        encoderDrive(0.9, 0.9,2438, 2438, 5.0); // Reverse 2438
